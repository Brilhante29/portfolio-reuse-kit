...
$requiredFiles = @(
  ...
  "contracts/fixtures/ci-profile-v1.valid.json",
  ...
  "docs/delivery-observability-infra.md",
  "harness/bench.py",
...
Require-Pattern "contracts/backend-reliability-platform.yaml" "^traffic_platform_edge:"
Require-Pattern "contracts/backend-reliability-platform.yaml" "cross_tenant_leakage"
...
Require-Pattern "contracts/manifest.json" '"contract_set_version": "1.6.0"'
