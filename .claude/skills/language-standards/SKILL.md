...
description: Select and apply repository conventions for the chosen stack profile or implementation framework, including Spring Kotlin, FastAPI, Go backend, Angular, Next.js, Python, Java, TypeScript, Terraform, package layout, testing, linting, Docker, benchmark rules, and README expectations.
---
...
4. Apply language/framework conventions without overriding the architecture and messaging decisions.
