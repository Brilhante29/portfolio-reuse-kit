...
description: Build or audit reusable GitHub Actions workflows for Python, Go, Node, JVM Gradle, or Terraform repositories. Use when Claude must select a stack-specific CI profile, secure workflow_call boundaries, prove the template through an executable fixture, or publish exact-head CI evidence without mutable refs or arbitrary command inputs.
---
