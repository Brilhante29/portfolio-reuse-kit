...
| Project contract | `contracts/` | Defines required shape for `project.yaml`, benchmark JSON, cross-repository artifacts, medical evaluation, and reusable CI profiles. |
