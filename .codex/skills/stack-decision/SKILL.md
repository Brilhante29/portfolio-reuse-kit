---
name: stack-decision
description: Choose the concrete stack profile for a portfolio repository from the decision brain, including Spring Kotlin backend, FastAPI backend, Go backend, Angular, Next.js, Python ML, or Terraform, based on problem forces, public signal, architecture, benchmark, and rejected alternatives.
---
...
7. Create or update `sdd/technical-decision.md` from `sdd/templates/technical-decision.md` when the stack changes libraries, runtime, Docker services, or benchmark methodology.
...
Rule: never write "use Python/Java/Go" as the decision. Use a concrete profile.
